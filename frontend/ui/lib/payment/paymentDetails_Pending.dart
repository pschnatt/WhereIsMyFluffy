...
class PaymentDetailsPending extends StatelessWidget {
  const PaymentDetailsPending({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const PaymentDetailItem(label: 'Status', value: 'Pending'),
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      // Implement re-upload transaction functionality
                    },
                    child: const Text('Re-upload Transaction'),
                  ),
                ],
              ),
            ),
