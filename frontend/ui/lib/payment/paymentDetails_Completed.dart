...
class PaymentDetailsCompleted extends StatelessWidget {
  const PaymentDetailsCompleted({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const PaymentDetailItem(label: 'Status', value: 'Completed'),
